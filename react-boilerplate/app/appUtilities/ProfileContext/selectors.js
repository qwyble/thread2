...
export const makeSelectParams = () => createSelector(
  makeSelectMatch,
  match => match.params
);

export const makeSelectProfileParam = () => createSelector(
  makeSelectParams,
...
export const makeSelectProfile = () => createSelector(
  ...
  makeSelectUser,
(profileContext, user) => {
    if (!profileContext.get('profile').isEmpty()) return profileContext.get('profile');
    return user;
  }
);
